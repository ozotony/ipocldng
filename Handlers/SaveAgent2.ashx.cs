...
{
    /// <summary>
    /// Summary description for SaveAgent2
    /// </summary>
    public class SaveAgent2 : IHttpHandler
    {
    ...
    new MailAddress(vemail));
                ...
                ss2 = ss2 + "To gain access to your account, you would need to click here <a href=\"http://88.150.164.30/NewCld/#/Register/" + vid + " \">click</a>   to validate your account and also make payment. " + "<br/><br/><br/>";
