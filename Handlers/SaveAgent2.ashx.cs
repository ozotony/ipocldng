...
namespace Ipong.Handlers
{
    ...
    new MailAddress(vemail));
                ...
                ss2 = ss2 + "To gain access to your account, you would need to click here <a href=\"http://5.77.54.44/NewCld/#/Register/" + vid + " \">click</a>   to validate your account and also make payment. " + "<br/><br/><br/>";
