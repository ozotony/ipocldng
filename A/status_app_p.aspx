<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="status_app_p.aspx.cs" Inherits="Ipong.A.status_app_p"  MaintainScrollPositionOnPostback="true"%>
       ...
       <tr>
        ...
        <tr >
            <td class="center-align">
                <a href="./xstatus_tm_apps.aspx">
                    <img alt="" src="../images/TRADEMARKS.png" style="width: 100px; height: 100px" /></a></td>
            <td class="center-align">
                <a href="./xstatus_pt_apps.aspx">
                    <img alt="" src="../images/patent.png" style="width: 100px; height: 100px" /></a></td>
            <td class="center-align">
                <a href="./xstatus_ds_apps.aspx">
                    <img alt="" src="../images/DESIGNS.png" style="width: 100px; height: 100px" /></a></td>
        </tr>
       
        <tr >
            <td class="center-align"> 
                 <a href="./xstatus_tm_apps.aspx">TRADEMARKS</a></td>
            <td class="center-align">
                 <a href="./xstatus_pt_apps.aspx">PATENT</a></td>
           <td class="center-align">
             <a href="./xstatus_ds_apps.aspx">DESIGN</a></td>
        </tr>
