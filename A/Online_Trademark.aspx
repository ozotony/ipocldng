<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Online_Trademark.aspx.cs" Inherits="Ipong.Agent_Accreditation.Online_Trademark" %>
...
<div id="sticky1">
Enter a valid online application ID as displayed on your acknowledgement form.
</div>
              ...
              <%--  <td align="center">{{row.Sn}}</td>--%>
               ...
               <a target="_blank" ng-click="add2(row); $event.preventDefault(); $event.stopPropagation();" class="icon-bar" href="#"> <i class="fa  fa-paypal "></i></a>
                   ...
                   <td align="center">
                     ...
                     <input id="Button1" type="button"  ng-click="EditRow(row)" value="Update T003" />
            </td>
