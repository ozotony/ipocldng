<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AlterationPatent_Recordal.aspx.cs" Inherits="Ipong.A.AlterationPatent_Recordal" %>
...
<head >
    ...
    <script src="../js/AngularLogin12.js"></script>
...
<div id="sticky1">
Enter a valid Transaction No as displayed on your Certificate Of Registration.
</div>
...
<div class="stickystatus"></div>
  ...
  <table class="table table-responsive table-bordered ">
    ...
    Search Using File/Tp No
          ...
          <td>
         <input type="text" ng-model="OnlineNumber" data-tooltip="sticky1" ng-show="checked" class="form-control" id="OnlineNumber" placeholder="Transaction Number">
        ...
        <tbody>
            <tr ng-repeat="row in displayedCollection">
              ...
              <%--  <td align="center">{{row.Sn}}</td>--%>
                ...
                <td >{{row.kk.validationID}}</td>
                <td >{{row.kk2.reg_date}}</td>
                 <td >{{row.kk2.reg_number}}</td>
                <td>{{row.kk3.xname}}</td>
                <td >{{row.kk2.title_of_invention}}</td>
                 <td >{{row.kk.applicantID}}</td>
                
                
                 <td >{{row.kk.data_status}}</td>
