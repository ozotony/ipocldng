<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="JournalPublication.aspx.cs" Inherits="Ipong.A.JournalPublication" %>
...
<head >
    ...
    <script src="../js/AngularLogin11.js"></script>
   ...
   <div class="row col-lg-11 col-md-11"> 
        ...
        <thead>
            <tr>
                ...
                <th st-sort="oai_no" class="tbbg2">SN</th>
                <th st-sort="reg_dt" class="tbbg2">Batch</th>
                 <th st-sort="reg_no" class="tbbg2"> Application Count</th>
        ...
        <tbody>
            <tr ng-repeat="row in displayedCollection">
                ...
                <td >Batch No :  {{row.Batchno}}</td>
                <td >{{row.Batchcount| number}}</td>
                
              

                 <td align="center">
               
               <a target="_blank" ng-click="add2(row); $event.preventDefault(); $event.stopPropagation();" class="icon-bar disabled" href="#"> <i class="fa  fa-paypal "></i></a>
