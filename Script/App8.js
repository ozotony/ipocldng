...
var migrateGe = 'http://88.150.164.30/MigratedGe/'
...
app.controller('formController', function ($scope, $state, $rootScope, $http, $stateParams, $location) {
    ...
    $scope.add = function () {
        ...
        if ($scope.formData.Searchname == "rtm") {
            serviceBase = migrateGe +  'api/values/GetData2';
            // serviceBase = 'http://localhost:40768/api/values/GetData2';
        }

        else {
            serviceBase = migrateGe + 'api/values/GetData';
        ...
        $http.get(serviceBase, { params: data }, { headers: { 'Content-Type': 'application/x-www-form-urlencoded' } }).success(function (response) {
            ...
            if (response != "null") {
                ...
                $rootScope.Recordal_Id = response.pwallet.ID;
                ...
                if (response.mark_info.logo_pic != "") {
                    ...
                    $scope.formData.logo_pic = serviceBaseCld +  "admin/tm/" + response.mark_info.logo_pic;
                ...
                if (response.mark_info.auth_doc != "") {
                    ...
                    $scope.formData.auth_doc = serviceBaseCld +  "admin/tm/" + response.mark_info.auth_doc;
                ...
                if (response.mark_info.sup_doc2 != "") {
                    ...
                    $scope.formData.sup_doc2 = serviceBaseCld + "admin/tm/" + response.mark_info.sup_doc2;
                ...
                if (response.mark_info.sup_doc1 != "") {

                    $scope.formData.sup_doc1 = serviceBaseCld + "admin/tm/" + response.mark_info.sup_doc1;
                ...
                var serviceBase2 = serviceBaseCld + 'Handlers/GetRecordal.ashx';
