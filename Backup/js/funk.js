...
function printAssessment(node) {
  ...
  var pwin=window.open('','print_content');
  pwin.document.open();
  pwin.document.write('<html><link href="css/print_style.css" rel="stylesheet" type="text/css" /><body onload="window.print()" ><style>.tiger-stripe{ font-size:12px;text-align:center;} .tiger-stripe tr:nth-child(odd) {background: #E3EAEB;color:#000000;} </style>' + content + '</body></html>');
  pwin.document.close();
}
...
function PrintHomePt(node) {
    ...
    var pwin = window.open('', 'print_content');
    pwin.document.open();
    pwin.document.write('<html><link href="../css/style.css" rel="stylesheet" type="text/css" /><body onload="window.print()" ><style>.tiger-stripe{ font-size:12px;text-align:center;} .tiger-stripe tr:nth-child(odd) {background: #E3EAEB;color:#000000;} </style>' + content + '</body></html>');
    pwin.document.close();
}
...
function printStatus(node) {
    ...
    var pwin = window.open('', 'print_content');
    pwin.document.open();
    pwin.document.write('<html><link href="../css/structure.css" rel="stylesheet" type="text/css" /><body onload="window.print()" ><style>.tiger-stripe{ font-size:12px;text-align:center;} .tiger-stripe tr:nth-child(odd) {background: #E3EAEB;color:#000000;} </style>' + content + '</body></html>');
    pwin.document.close();
}
