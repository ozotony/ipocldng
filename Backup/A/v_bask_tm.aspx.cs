...
namespace Ipong.A
{
    public partial class v_bask_tm : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if ((Session["agentType"] != null) && (Session["agentType"].ToString() != ""))
            {
                ...
                tm_cnt = ret.getCombinedPaidFee_detail_ItemsCntByCat(adminID, "tm", "1", agentType);
                used_cnt = ret.getPaidUsedCntByCat(adminID, "tm", "1", agentType, "Used");
                unused_cnt = ret.getPaidUsedCntByCat(adminID, "tm", "1", agentType, "Not Used");
