<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="status_p.aspx.cs" Inherits="Ipong.A.status_p"  MaintainScrollPositionOnPostback="true"%>
...
<table  style="width: 100%; text-align:center;">
       <tr>
        ...
        <tr >
            ...
            <td class="center-align">
                <a href="./xstatus_payments.aspx">
                    <img alt="" src="../images/PAYMENT HISTORY.png" style="width: 100px; height: 100px" /></a></td>
        </tr>
       
        <tr >
            <td class="center-align">
            <a href="./status_app_p.aspx">APPLICATIONS</a></td>
            <td class="center-align">
            <a href="./xstatus_payments.aspx">PAYMENTS</a></td>
        </tr>
