<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="xstatus_ds_apps.aspx.cs" Inherits="Ipong.A.xstatus_ds_apps"  MaintainScrollPositionOnPostback="true"%>
...
&nbsp;<asp:Button ID="btnNewSearch" runat="server" class="button" Text="New Search" onclick="btnNewSearch_Click" />  
       ...
       <tr>
        ...
        <% } %>
         ...
         <tr>
            <td colspan="2">
                 <input type="button" name="Printform" id="Button1" value="Print" onclick="printStatus('ark');return false" class="button" />                 <asp:Button ID="btnNewSearch2" runat="server" class="button" Text="New Search" onclick="btnNewSearch2_Click" />  
            </td>
        </tr>
        <% }
           %> 
