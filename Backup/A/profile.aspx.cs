...
namespace Ipong.A
{
    ...
    {
        public string adminID = "0"; protected string agentType = ""; protected string xreg_date = DateTime.Now.ToString("yyyy-MM-dd");
        protected string fullname = ""; protected string email = ""; protected string mobile = ""; protected string coy_name = "";
        protected string cust_id = ""; public string log_date = "";
