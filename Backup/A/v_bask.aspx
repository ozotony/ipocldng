<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="v_bask.aspx.cs" Inherits="Ipong.A.v_bask"  MaintainScrollPositionOnPostback="true"%>
       ...
       <tr>
        ...
        <tr >
            <td class="center-align">
                <a href="./v_bask_tm.aspx">
                    <img alt="" src="../images/TRADEMARKS.png" style="width: 100px; height: 100px" /></a></td>
            <td class="center-align">
                <a href="./v_bask_pt.aspx">
                    <img alt="" src="../images/patent.png" style="width: 100px; height: 100px" /></a></td>
            <td class="center-align">
                <a href="./v_bask_ds.aspx">
                    <img alt="" src="../images/DESIGNS.png" style="width: 100px; height: 100px" /></a></td>
        </tr>
        ...
        <tr >
            ...
            <br />
                 <a href="./v_bask_tm.aspx">TRADEMARKS</a></td>
            <td class="center-align">
            <strong><%=pt_cnt%> Item(s)</strong>
            <br />
                 <a href="./v_bask_pt.aspx">PATENT</a></td>
           <td class="center-align">
            <strong><%=ds_cnt%> Item(s)</strong>
            <br />
             <a href="./v_bask_ds.aspx">DESIGN</a></td>
        </tr>
