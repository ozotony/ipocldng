<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="mem_reg_succ.aspx.cs" Inherits="Ipong.mem_reg_succ" %>
     ...
     <tr class="center-align">
        ...
        <tr>
            <td width="20%" class="center-align" style="font-size:14px;">
                ...
                APPLICANT : <strong>" <%= x.ToUpper() %>  "</strong> WITH REGISTRATION NUMBER : <strong>"<%= m.ToUpper() %> "</strong> HAS BEEN REGISTERED SUCCESSFULLY!! <br /> &nbsp;PLEASE CHECK YOUR E-MAIL FOR FURTHER DETAILS</td>
        </tr>
