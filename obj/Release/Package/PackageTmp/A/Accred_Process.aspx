<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Accred_Process.aspx.cs" Inherits="Ipong.A.Accred_Process" %>
       ...
       <tr>
        ...
        <tr >
            <td class="center-align">
                <a href="./status_app_p.aspx">
                    <img alt="" src="../images/Agent_Right.jpg" style="width: 100px; height: 100px" /></a></td>
            <td class="center-align">
                <a href="../agent_accreditation\Accreditation_Status.aspx">
                    <img alt="" src="../images/App_Status.jpg" style="width: 100px; height: 100px" /></a></td>
        </tr>
       
        <tr >
            <td class="center-align">
            <a href="../agent_accreditation\assign_role.aspx">Accreditation Admin Manager</a></td>
            <td class="center-align">
            <a href="../agent_accreditation\Accreditation_Status.aspx">Accreditation Status</a></td>
        </tr>
