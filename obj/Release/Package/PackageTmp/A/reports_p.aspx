<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="reports_p.aspx.cs" Inherits="Ipong.A.reports_p"  MaintainScrollPositionOnPostback="true"%>
       ...
       <tr>
        ...
        <tr >
            <td class="center-align">
                <a href="./xreport_apps.aspx">
                    <img alt="" src="../images/FORMS.png" style="width: 100px; height: 100px" /></a></td>
            <td class="center-align">
                <a href="./xreport_payments.aspx">
                    <img alt="" src="../images/PAYMENT HISTORY.png" style="width: 100px; height: 100px" /></a></td>
        </tr>
       
        <tr >
            <td class="center-align">
            <a href="./xreport_apps.aspx">APPLICATIONS</a></td>
            <td class="center-align">
            <a href="./xreport_payments.aspx">PAYMENTS</a></td>
        </tr>
...
<div id="bottom_footer">
     POWERED BY<br /><img alt="Einao Solutions" class="style2" src="../images/einao_logo.png" />&nbsp;<img alt="Interswitch" class="style2" src="../images/isw_logo_small.gif" /></div>
