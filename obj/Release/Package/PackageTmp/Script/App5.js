...
var serviceBasePt = 'http://localhost:55482/'
...
app.config(function ($stateProvider, $urlRouterProvider) {
    ...
    $stateProvider
        ...
        .state('form.search2', {
            ...
            templateUrl: 'Change_Name_Detailb.html'
        })
        .state('form.search', {
            url: '/search',
            templateUrl: 'Change_Name_Detailb.html'
...
app.controller('formController', function ($scope, $state, $rootScope, $http, $stateParams, $location) {
    ...
    $scope.add = function () {
        ...
        if ($scope.formData.Searchname == "rtm") {
            serviceBase = serviceBasePt + 'Handlers/GetData4.ashx';
            //  serviceBase = 'http://localhost:40768/api/values/GetData2';
        }

        else {
            serviceBase = serviceBasePt +  'Handlers/GetData5.ashx';
    ...
    $scope.submitForm = function (isValid) {
      ...
      //  formData.append("vv", JSON.stringify($scope.formData.OnlineNumber));
        ...
        if ($scope.formData.Searchname == "rtm") {
            ...
            url9 =serviceBasePt + "Handlers/Save_GenericApplication3.ashx";
        }

        else {

            url9 =serviceBasePt +  "Handlers/Save_GenericApplication4.ashx";
        }
