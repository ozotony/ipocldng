<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="bank_reg.aspx.cs" Inherits="Ipong.bank_reg" %>
     ...
     <tr class="center-align">
        ...
        <tr>
            <td colspan="2" class="center-align" style="background-color:#1C5E55; color:#ffffff;">
                BANKER REGISTRATION : PLEASE FILL IN ALL THE DETAILS BELOW  
            </td>
        </tr>
        ...
        <tr>
            <td align="left">
                &nbsp; BANK POSITION :&nbsp;</td>
            <td align="left">
                <asp:TextBox ID="xposition" runat="server" Width="400px" CssClass="textbox" ></asp:TextBox> 
