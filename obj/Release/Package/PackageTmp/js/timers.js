...
function CountUp(initDate, id, msg) {
    ...
    this.updateCounter();
    this.countainer.onclick = function () { window.location = "http://ipo.cldng.com/A/profile.aspx"; };
}
...
//    " <strong> " + this.msg + " </strong>";
    ...
    this.countainer.innerHTML = " <strong>" + this.minutes + "</strong> <small>" + (this.minutes == 1 ? "minute" : "minutes") + "</small>" +
        " <strong>" + this.seconds + "</strong> <small>" + (this.seconds == 1 ? "second" : "seconds") + "</small>" +
        " <strong> " + this.msg + " </strong>";
    var self = this;
    setTimeout(function () { self.updateCounter(); }, 1000);
