...
function printA(node) {
    ...
    pwin.document.open();
    pwin.document.write('<html><link href="../css/style.css" rel="stylesheet" type="text/css" /><body onload="window.print()" ><style>.tiger-stripe{ font-size:14px;font-weight:bold;} .tiger-stripe tr:nth-child(odd) {background: #E3EAEB;color:#000000;font-size:14px;font-weight:bold;} .item_alt {background-color:#E3EAEB;font-size:14px;font-weight:bold;   }</style>' + content + '</body></html>');
    pwin.document.close();
}
...
function printAssessment(node) {
  ...
  var pwin=window.open('','print_content');
  pwin.document.open();
  pwin.document.write('<html><link href="css/print_style.css" rel="stylesheet" type="text/css" /><body onload="window.print()" ><style>.tiger-stripe{ font-size:12px;text-align:left;} .tiger-stripe tr:nth-child(odd) {background: #E3EAEB;color:#000000;} </style>' + content + '</body></html>');
  pwin.document.close();
}
...
function PrintPartner(node) {
    ...
    var pwin = window.open('', 'print_content');
    pwin.document.open();
    pwin.document.write('<html><link href="../css/style.css" rel="stylesheet" type="text/css" /><body onload="window.print()" ><style>.tiger-stripe{ font-size:12px;text-align:left;} .tiger-stripe tr:nth-child(odd) {background: #E3EAEB;color:#000000;} </style>' + content + '</body></html>');
    pwin.document.close();
}

function PrintHomePt(node) {
...
function printStatus(node) {

    var content = document.getElementById(node).innerHTML
    var pwin = window.open('', 'print_content');
    pwin.document.open();
    pwin.document.write('<html><link href="../css/structure.css" rel="stylesheet" type="text/css" /><link href="../css/style.css" rel="stylesheet" type="text/css" /><body onload="window.print()" ><style>.tiger-stripe{ font-size:12px;text-align:left;} .tiger-stripe tr:nth-child(odd) { font-size:12px;text-align:left;background: #E3EAEB;color:#000000;} </style>' + content + '</body></html>');
    pwin.document.close();
}
