<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="agt_reg_succ.aspx.cs" Inherits="Ipong.agt_reg_succ" %>
     ...
     <tr class="center-align">
        ...
        <tr>
            <td class="center-align" style="background-color:#1C5E55; color:#ffffff;">
                AGENT REGISTRATION SUCCESSFULL!! 
            </td>
        </tr>
        ...
        <tr>
            <td width="20%" class="center-align" style="font-size:14px;">
                ...
                AGENT : <strong>" <%= x.ToUpper() %>  "</strong> WITH REGISTRATION NUMBER : <strong>"<%= m.ToUpper() %> "</strong> HAS BEEN REGISTERED SUCCESSFULLY!! <br /> &nbsp;PLEASE CHECK YOUR E-MAIL FOR FURTHER DETAILS</td>
        </tr>
