<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="upd_pro.aspx.cs" Inherits="Ipong.upd_pro" %>
...
<body>
    ...
    <table  id="registration_form" class="center-align" width="100%" class="form" >           
     <tr class="center-align">
        ...
        <tr>
            <td colspan="2" class="center-align" style="background-color:#1C5E55; color:#ffffff;"></td>
        </tr>
