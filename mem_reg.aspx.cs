...
namespace Ipong
{
    public partial class mem_reg : System.Web.UI.Page
    {
        ...
        private Classes.XObjs.XMember xmem= new Classes.XObjs.XMember();
                        ...
                        { 
                           ...
                           addyID = reg.addXpayAddress(xaddy);
                            ...
                            if (addyID > 0)
                            {
                                ...
                                xmem.sys_ID = "";
                                memberID = reg.addXpayMember(xmem);
                                ...
                                if (memberID > 0)
                                {
                                    ...
                                    Response.Redirect("mem_reg_succ.aspx?x=" + xname.Text.ToUpper() + "&m=CLD/RC/" + memberID.ToString().PadLeft(5, '0'));
                                }
                            }
