    ...
    public class tm
    {
       // public GatewayService iposervice = new GatewayService();
        ...
        public string a_applicant(string name, string type, string tax_id_type, string tax_id_number, string individual_id_number, string nationality, string residence, string xstate, string xcity, string street, string xzip, string xtelephone, string xemail, string agentID, string amt, string validationID, string stage)
        {
            ...
            SqlCommand command3 = new SqlCommand("DELETE FROM address WHERE xID='" + num + "' ", connection3);
            connection3.Open();
            command3.ExecuteNonQuery();
            connection3.Close();
            SqlConnection connection4 = new SqlConnection(connectionString);
            SqlCommand command4 = new SqlCommand("DELETE FROM applicant WHERE xID='" + str3 + "' ", connection4);
            connection4.Open();
        ...
        public string a_representative(string xcode, string xname, string individual_id_type, string individual_id_number, string nationality, string residence, string xstate, string xcity, string street, string xzip, string xtelephone, string xemail, string validationID, string agentID, string amt, string stage)
        {
            ...
            SqlConnection connection2 = new SqlConnection(connectionString);
            SqlCommand command2 = new SqlCommand("DELETE FROM address WHERE xID='" + num + "' ", connection2);
            connection2.Open();
            command2.ExecuteNonQuery();
            connection2.Close();
            SqlConnection connection3 = new SqlConnection(connectionString);
            SqlCommand command3 = new SqlCommand("DELETE FROM representative WHERE xID='" + str3 + "' ", connection3);
            connection3.Open();
            command3.ExecuteNonQuery();
            connection3.Close();
            return "0";
        ...
        {
            if (c_app_addy.countryID == null)  { c_app_addy.countryID = "";  }
            if (c_app_addy.stateID == null) {  c_app_addy.stateID = "";}
            if (c_app_addy.city == null) { c_app_addy.city = ""; }
            if (c_app_addy.street == null) { c_app_addy.street = "";}
            if (c_app_addy.telephone1 == null)  {c_app_addy.telephone1 = "";  }
            if (c_app_addy.email1 == null) {c_app_addy.email1 = ""; }
        ...
        {
            if (c_aos.countryID == null){ c_aos.countryID = ""; }
            if (c_aos.stateID == null) { c_aos.stateID = ""; }
            if (c_aos.city == null) { c_aos.city = ""; }
            if (c_aos.street == null) { c_aos.street = ""; }
            if (c_aos.telephone1 == null) { c_aos.telephone1 = "";   }
            if (c_aos.email1 == null) {  c_aos.email1 = ""; }
            string connectionString = this.Connect();
            string str4 = "0";
            SqlConnection connection = new SqlConnection(connectionString);
            SqlCommand command = connection.CreateCommand();
        ...
        public string addApplicant(Applicant c_app, Address c_app_addy, string pwalletID)
        {
            ...
            addressID = this.addAddress(c_app_addy, pwalletID);
            string connectionString = this.Connect();
            string str5 = "";
            SqlConnection connection = new SqlConnection(connectionString);
            SqlCommand command = connection.CreateCommand();
        ...
        public int addXTransaction(XTransaction x)
        {
            ...
            str2 = Convert.ToInt32(command.ExecuteScalar());
            connection.Close();
            return str2;
        }
         ...
         public string doUploadExcelDoc(string ID, string path, FileUpload fu)
        {
            ...
            try
            {
                ...
                string str2 = Path.GetFileName(fu.FileName).Replace(" ", "_");
                string ext =getExtension(str2);
                if (ext =="xls")
                {
                    fu.SaveAs(path + ID + "/" + str2);
                    str = DateTime.Now.TimeOfDay.ToString().Replace(".", "_").Replace(":", "+").Substring(0,8);
                    newpath = path + ID + "/" + str + "." + ext;
                    File.Move(path + ID + "/" + str2, newpath);
                    return newpath;
                }
                else
                {
        ...
        public int e_pwallet(string validationID, string agentID, string amt, string stage, string data_status)
        {
            ...
            SqlConnection connection2 = new SqlConnection(connectionString);
            connection2.Open();
            SqlCommand command2 = new SqlCommand("sp_a_pwallet", connection2) {
                CommandType = CommandType.StoredProcedure
            };
            command2.Parameters.Add(new SqlParameter("@validationID", validationID));
            command2.Parameters.Add(new SqlParameter("@applicantID", agentID));
            command2.Parameters.Add(new SqlParameter("@amt", amt));
            command2.Parameters.Add(new SqlParameter("@stage", stage));
            command2.Parameters.Add(new SqlParameter("@data_status", data_status));
            command2.Parameters.Add(new SqlParameter("@reg_date", str2));
            command2.Parameters.Add(new SqlParameter("@visible", str4));
            SqlParameter parameter2 = command2.Parameters.Add("@ReturnVal", SqlDbType.Int);
        ...
        public void flushMark_infoByID(string serverpath, string id)
        {
            string connectionString = this.Connect();
            SqlConnection connection2 = new SqlConnection(connectionString);
            SqlCommand command2 = new SqlCommand("DELETE from mark_info where xID='" + id + "'", connection2);
            connection2.Open();
            command2.ExecuteNonQuery();
            connection2.Close();
        ...
        public Applicant getApplicantByUserID(string ID)
        {
            ...
            applicant.xtype = "";
            applicant.xname = "";
            applicant.tax_id_type = "";
            applicant.tax_id_number = "";
            applicant.individual_id_number = "";
        ...
        public string getCheckStatusDetails2(string validationID, string agentID)
        {
            string str = "";
        ...
        public string getFormattedAddressByID(string ID)
        {
            ...
            if ((address.stateID != null) || (address.stateID != ""))
            {
                ...
                string str5 = str;
                return (str5 + address.street + "," + address.city + "," + this.getStateName(address.stateID) + "," + this.getCountryName(address.countryID));
            }
            string str6 = str;
            return (str6 + address.street + "," + address.city + "," + this.getCountryName(address.countryID));
        }
        ...
        {
            if (name == "NAME AND DEVICE") { name = "WORD AND DEVICE"; }
            if ((name == "MARK NAME")||(name=="MARK ONLY")) { name = "WORD MARK"; }
        ...
        public List<MarkInfo> getMarkInfoByProductTitle(string ID)
        {
            List<MarkInfo> list = new List<MarkInfo>();
            new MarkInfo();
            SqlConnection connection = new SqlConnection(this.Connect());
            SqlCommand command = new SqlCommand("SELECT * FROM mark_info WHERE product_title='" + ID + "' ", connection);
            connection.Open();
            SqlDataReader reader = command.ExecuteReader(CommandBehavior.CloseConnection);
            while (reader.Read())
            {
        ...
        public Stage getStageByTransID(string validationID)
        {
        ...
        public List<Stage> getBasketStageByUserIDAcc(string validationID, string agentID)
        {
            List<Stage> list = new List<Stage>();
            SqlConnection connection = new SqlConnection(this.Connect());
            SqlCommand command = new SqlCommand("SELECT ID,status,data_status FROM pwallet WHERE validationID='" + validationID + "'  AND applicantID='" + agentID + "' AND stage='5' AND data_status <>'' ", connection);
            command.CommandTimeout = 300;
            connection.Open();
            SqlDataReader reader = command.ExecuteReader(CommandBehavior.CloseConnection);
            while (reader.Read())
        ...
        public List<Stage> getStageByUserIDAccTm(string validationID, string agentID)
        {
            List<Stage> list = new List<Stage>();
            SqlConnection connection = new SqlConnection(this.Connect());
        ...
        public List<Stage> getStageByUserIDAccTm2(string validationID, string agentID)
        {
            List<Stage> list = new List<Stage>();
            SqlConnection connection = new SqlConnection(this.Connect());
            SqlCommand command = new SqlCommand("SELECT * FROM g_pwallet WHERE validationID='" + validationID + "'  AND applicantID='" + agentID + "' AND stage='5' AND data_status <>'' ", connection);
            command.CommandTimeout = 300;
            connection.Open();
            SqlDataReader reader = command.ExecuteReader(CommandBehavior.CloseConnection);
            while (reader.Read())
        ...
        public List<Stage> getStageByUserIDAccPt(string validationID, string agentID)
        {
            List<Stage> list = new List<Stage>();
        ...
        public List<Stage> getStageByUserIDAccDs(string validationID, string agentID)
        {
            List<Stage> list = new List<Stage>();
            SqlConnection connection = new SqlConnection(this.ConnectDs());
            SqlCommand command = new SqlCommand("SELECT * FROM pwallet WHERE validationID='" + validationID + "'  AND applicantID='" + agentID + "'  AND data_status <>'' ", connection);
        ...
        public List<Stage> getStageByClientIDAcc2(string validationID)
        {
            List<Stage> list = new List<Stage>();
            SqlConnection connection = new SqlConnection(this.ConnectDs());
            SqlCommand command = new SqlCommand("SELECT * FROM pwallet WHERE validationID='" + validationID + "'  AND data_status <>'' ", connection);
        ...
        //    try
        //    {
        //        status = Convert.ToInt32(this.iposervice.UpdateTransaction(transID, gt, stat));
        //    }
        //    catch (System.FormatException fe)
        //    {
        //        status = 0;
        ...
        public string updateOldDateMarkReg(string xID, string typ, string yr)
        {
            ...
            if (typ == "1")
            {
                reg_number = "NG/TM/O/" + yr + "/" + xID;
            }
            else
            {
                reg_number = "F/TM/O/" + yr + "/" + xID;
            }
            SqlConnection connection = new SqlConnection(this.Connect());
            SqlCommand command = connection.CreateCommand();
            command.CommandText = "UPDATE mark_info SET reg_number=@reg_number WHERE xID=@xID ";
