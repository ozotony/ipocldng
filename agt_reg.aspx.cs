...
namespace Ipong
{
    public partial class agt_reg : System.Web.UI.Page
    {
        ...
        protected void btnAddMember_Click(object sender, EventArgs e)
        {
            ...
            if ((xname.Text == "") || (cname.Text == "") || (xcity.Text == "") || (xaddress.Text == "") || (xtelephone.Text == "") || (xemail.Text == "") || (xpass.Text == "") || (xcode.Text == ""))
            {
                if (xname.Text == "") { xname.BorderColor = System.Drawing.Color.Red; } else { xname.BorderColor = System.Drawing.Color.Green; }
                if (cname.Text == "") { cname.BorderColor = System.Drawing.Color.Red; } else { cname.BorderColor = System.Drawing.Color.Green; }
            ...
            else if ((xname.Text != "") && (cname.Text != "") && (xcity.Text != "") && (xaddress.Text != "") && (xtelephone.Text != "") && (xemail.Text != "") && (xpass.Text != "") && (xcode.Text != ""))
            {
                        ...
                        { 
                           ...
                           addyID = reg.addXpayAddress(xaddy);
                            ...
                            if (addyID > 0)
                            {
                                ...
                                xmem.sys_ID = "";
                                memberID = reg.addXpayAgent(xmem);
                                ...
                                if (memberID > 0)
                                {
                                    ...
                                    cname.BorderColor = System.Drawing.Color.White;
                                    ...
                                    xcode.BorderColor = System.Drawing.Color.White;
                                    ...
                                    msg += " Username: " + xemail.Text + "<br/>"; msg += "Password: " + xpass.Text + "<br/>System ID :CLD/RA/" + memberID.ToString().PadLeft(5, '0') + ",<br/>Regards";
                                    string xmsg = "Dear " + xname.Text + ",\r\n";
                                    xmsg += "You have been registered on the CLD Platform!Please store the details below\r\n";
                                    xmsg += "Username: " + xemail.Text + ";\r\n"; xmsg += "Password:\r\n" + xpass.Text + ";\r\nSystem ID :CLD/RA/" + memberID.ToString().PadLeft(5, '0') + ",\r\nRegards";
                                    ...
                                    Response.Redirect("agt_reg_succ.aspx?x=" + xname.Text.ToUpper() + "&m=CLD/RA/" + memberID.ToString().PadLeft(5, '0'));
                                }
                            }
