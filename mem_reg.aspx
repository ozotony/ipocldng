<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="mem_reg.aspx.cs" Inherits="Ipong.mem_reg" %>
     ...
     <tr class="center-align">
        ...
        <tr>
            <td colspan="2" class="center-align" style="background-color:#1C5E55; color:#ffffff;">
                CLIENT REGISTRATION : PLEASE FILL IN ALL THE DETAILS BELOW  
            </td>
        </tr>
        ...
        <tr>
            <td colspan="2" class="center-align">
                ...
                <asp:Button ID="btnAddMember" runat="server" class="button" Text="I confirm that the above entries are correctT" 
