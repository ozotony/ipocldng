...
namespace Ipong.ExcelClasses
{
    public struct ExcelColor
    {
        ...
        {
            get { return new ExcelColor(Color.FromKnownColor(KnownColor.WindowText), 0x18); }
        }

        public static ExcelColor WindowBackground
        {
            get { return new ExcelColor(Color.FromKnownColor(KnownColor.Window), 0x19); }
        }

        public static ExcelColor Automatic
        {
            get { return new ExcelColor(Color.FromKnownColor(KnownColor.WindowText), BIFF.DefaultColor); }
        }
